...
## Purpose
Provides vehicle speed-proportional return-to-center steering decay, user interaction priority, bidirectional UI synchronization, and cross-drivetrain support (Ackermann servos and Skid-Steer track differential offset).
