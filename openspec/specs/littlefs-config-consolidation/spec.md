...
Defines the consolidated LittleFS configuration system where ConfigParser is the single authority for all JSON parsing, and RcEngineSound::Config is the canonical vehicle config struct.
