# Virtual Mass Inertia Drivetrain Specification

## Purpose
Defines requirements for drivetrain virtual mass acceleration, coasting, and proportional braking simulation with direct mode fallback.
