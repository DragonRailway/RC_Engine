...
def main():
    ...
    cmd = [
        ...
        f"-I{os.path.join(REPO_ROOT, 'lib', 'ESP32_EasyKit', 'src')}",
        f"-I{os.path.join(REPO_ROOT, 'lib', 'rk-arduino', 'src')}",
        f"-I{os.path.join(REPO_ROOT, 'lib', 'SoundEngine', 'src')}",
        VC_SRC,
        os.path.join(REPO_ROOT, "test", "host_vc", "host_easykit_stubs.cpp"),
        os.path.join(REPO_ROOT, "lib", "ESP32_EasyKit", "src", "EasyLEDGroup.cpp"),
        os.path.join(REPO_ROOT, "lib", "SoundEngine", "src", "RcEngineSound.cpp"),
        os.path.join(REPO_ROOT, "lib", "rk-arduino", "src", "widgets", "Widget.cpp"),
        os.path.join(REPO_ROOT, "lib", "rk-arduino", "src", "widgets", "Button.cpp"),
        os.path.join(REPO_ROOT, "lib", "rk-arduino", "src", "widgets", "LED.cpp"),
        os.path.join(REPO_ROOT, "lib", "rk-arduino", "src", "widgets", "Multiple.cpp"),
        os.path.join(REPO_ROOT, "lib", "rk-arduino", "src", "widgets", "Telemetry.cpp"),
        os.path.join(REPO_ROOT, "lib", "rk-arduino", "src", "widgets", "Text.cpp"),
        os.path.join(REPO_ROOT, "lib", "rk-arduino", "src", "widgets", "Knob.cpp"),
        os.path.join(REPO_ROOT, "lib", "rk-arduino", "src", "widgets", "Slider.cpp"),
        os.path.join(REPO_ROOT, "lib", "rk-arduino", "src", "widgets", "SlideSwitch.cpp"),
        os.path.join(REPO_ROOT, "lib", "rk-arduino", "src", "widgets", "Joystick.cpp"),
        "-o", VC_BIN
    ]
